...
2. Build Command: _(leave empty unless using TypeScript)_
...
![Login](./docs/assets/Login.png.png)

### 📝 Register Page

![Register](./docs/assets/Register.png.png)

### 🏠 App Layout / Navbar

![App Layout](./docs/assets/App.png.png)

### 🖥️ Dashboard (Admin)

![Dashboard](./docs/assets/Dasboard.png.png)

### ➕ Create Task (Admin)

![Create Task](./docs/assets/CreateTask.png.png)

### 📋 All Tasks (Admin)

![All Tasks](./docs/assets/AllTasks.png.png)
